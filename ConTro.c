...
int main()
{
    ...
    printf("Dia chi con tro so nguyen %p \n",con_tro_so_nguyen);
    printf("Dia chi con tro so thuc %p \n",con_tro_so_thuc);
    printf("Dia chi con tro ky tu %p \n",con_tro_ky_tu);
...
//    Point2D *con_tro_a;
    ...
    //printf("\n Dia chi %p ",con_tro_so_nguyen);
//    *con_tro_so_nguyen = so_nguyen + 4;
//    printf("\n Noi dung con tro so nguyen %d ",*con_tro_so_nguyen);
//    printf("\n Dia chi cua bien nguyen %p ",&so_nguyen);
//    a.x = 0.5;
//    a.y = 0.5;
...
//    printf("\n Dia chi con tro point 2d %p ",con_tro_a);
